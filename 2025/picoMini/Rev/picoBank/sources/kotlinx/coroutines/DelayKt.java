...
public final class DelayKt {
    ...
    public static final Object m1659delayVtjQ1oo(long duration, Continuation<? super Unit> $completion) {
        Object delay = delay(m1660toDelayMillisLRDsOJo(duration), $completion);
    ...
    public static final long m1660toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        if (Duration.m1486compareToLRDsOJo($this$toDelayMillis_u2dLRDsOJo, Duration.Companion.m1589getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1505getInWholeMillisecondsimpl($this$toDelayMillis_u2dLRDsOJo), 1);
        }
        return 0;
    }
}
