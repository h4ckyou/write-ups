...
public interface ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object result = receiveChannel.m1698tryReceivePtdJZtk();
            if (ChannelResult.m1688isSuccessimpl(result)) {
                return ChannelResult.m1684getOrThrowimpl(result);
            }
            Throwable r1 = ChannelResult.m1682exceptionOrNullimpl(result);
            if (r1 == null) {
                return null;
            }
        ...
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) {
            ...
            L_0x002d:
                ...
                java.lang.Object r3 = r3.m1690unboximpl()
                goto L_0x0045
            L_0x0038:
                kotlin.ResultKt.throwOnFailure(r0)
                r2 = 1
                r4.label = r2
                java.lang.Object r3 = r3.m1697receiveCatchingJP2dKIU(r4)
