...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m1482minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.m1481plusLRDsOJo(Duration.m1539unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m1486compareToLRDsOJo($this.m1480minusUwyO8pc(other), Duration.Companion.m1589getZEROUwyO8pc());
        }
    }
}
