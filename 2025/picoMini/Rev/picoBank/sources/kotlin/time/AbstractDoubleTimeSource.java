...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark m1464minusLRDsOJo(long duration) {
        ...
        public ComparableTimeMark m1467plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1523plusLRDsOJo(this.offset, duration), (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-UwyO8pc  reason: not valid java name */
        public long m1465minusUwyO8pc(ComparableTimeMark other) {
            ...
            } else if (Duration.m1492equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m1519isInfiniteimpl(this.offset)) {
        ...
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual((Object) this.timeSource, (Object) ((DoubleTimeMark) other).timeSource) && Duration.m1492equalsimpl0(m1465minusUwyO8pc((ComparableTimeMark) other), Duration.Companion.m1589getZEROUwyO8pc());
        }
