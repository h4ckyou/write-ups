...
public final class UnsignedKt {
    ...
    public static final int m506uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m250constructorimpl((int) ((((long) v1) & 4294967295L) / (4294967295L & ((long) v2))));
    }
    ...
    public static final long m508ulongDivideeb3DHEI(long v1, long v2) {
        ...
        if (divisor < 0) {
            ...
            return ULong.m329constructorimpl(dividend / divisor);
        } else {
            int i = 1;
            long quotient = ((dividend >>> 1) / divisor) << 1;
            if (Long.compare(ULong.m329constructorimpl(dividend - (quotient * divisor)) ^ Long.MIN_VALUE, ULong.m329constructorimpl(divisor) ^ Long.MIN_VALUE) < 0) {
                i = 0;
            }
            return ULong.m329constructorimpl(((long) i) + quotient);
        }
    }
    ...
    public static final long m509ulongRemaindereb3DHEI(long v1, long v2) {
        ...
        if (divisor < 0) {
            ...
            if (Long.compare(ULong.m329constructorimpl(rem) ^ Long.MIN_VALUE, ULong.m329constructorimpl(divisor) ^ Long.MIN_VALUE) >= 0) {
                j = divisor;
            }
    ...
    public static final int doubleToUInt(double v) {
        ...
        return UInt.m250constructorimpl(UInt.m250constructorimpl((int) (v - ((double) Integer.MAX_VALUE))) + UInt.m250constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double v) {
        ...
        if (v < 9.223372036854776E18d) {
            return ULong.m329constructorimpl((long) v);
        }
        return ULong.m329constructorimpl(ULong.m329constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
