...
public final class UStringsKt {
    ...
    public static final String m1459toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1461toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1460toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1458toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m302unboximpl();
        if (Integer.compare(r0 ^ Integer.MIN_VALUE, UInt.m250constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m167boximpl(UByte.m173constructorimpl((byte) r0));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m302unboximpl();
        if (Integer.compare(r0 ^ Integer.MIN_VALUE, UInt.m250constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m430boximpl(UShort.m436constructorimpl((short) r0));
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m329constructorimpl((long) i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            result = ULong.m329constructorimpl(ULong.m329constructorimpl(((long) UInt.m250constructorimpl(digit)) & 4294967295L) + result2);
