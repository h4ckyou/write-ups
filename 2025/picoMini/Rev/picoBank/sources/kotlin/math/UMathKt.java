...
public final class UMathKt {
    ...
    private static final int m1374minJ1ME1BU(int a, int b) {
        return UComparisonsKt.m1356minOfJ1ME1BU(a, b);
    }

    /* renamed from: min-eb3DHEI  reason: not valid java name */
    private static final long m1375mineb3DHEI(long a, long b) {
        return UComparisonsKt.m1364minOfeb3DHEI(a, b);
    }

    /* renamed from: max-J1ME1BU  reason: not valid java name */
    private static final int m1372maxJ1ME1BU(int a, int b) {
        return UComparisonsKt.m1344maxOfJ1ME1BU(a, b);
    }

    /* renamed from: max-eb3DHEI  reason: not valid java name */
    private static final long m1373maxeb3DHEI(long a, long b) {
        return UComparisonsKt.m1352maxOfeb3DHEI(a, b);
    }
}
