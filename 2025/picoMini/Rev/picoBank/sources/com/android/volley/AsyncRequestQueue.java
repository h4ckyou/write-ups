...
public class AsyncRequestQueue extends RequestQueue {
    ...
    private class CacheParseTask<T> extends RequestTask<T> {
        ...
        public void run() {
            ...
            Response<?> response = this.mRequest.parseNetworkResponse(new NetworkResponse((int) ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, this.entry.data, false, 0, this.entry.allResponseHeaders));
