...
public abstract class Transition implements Cloneable {
    ...
    class SeekController extends TransitionListenerAdapter implements TransitionSeekController, DynamicAnimation.OnAnimationUpdateListener {
        ...
        public /* synthetic */ void m57lambda$ensureAnimation$0$androidxtransitionTransition$SeekController(DynamicAnimation anim, boolean canceled, float value, float velocity) {
            if (!canceled) {
                if (value < 1.0f) {
                    long duration = getDurationMillis();
