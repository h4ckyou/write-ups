...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    public /* synthetic */ void m45lambda$new$0$androidxfragmentappFragmentManager(Configuration newConfig) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m46lambda$new$1$androidxfragmentappFragmentManager(Integer level) {
    ...
    public /* synthetic */ void m47lambda$new$2$androidxfragmentappFragmentManager(MultiWindowModeChangedInfo info) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m48lambda$new$3$androidxfragmentappFragmentManager(PictureInPictureModeChangedInfo info) {
        if (isParentAdded()) {
    ...
    public Parcelable saveAllState() {
        ...
        Bundle savedState = m44lambda$attachController$4$androidxfragmentappFragmentManager();
