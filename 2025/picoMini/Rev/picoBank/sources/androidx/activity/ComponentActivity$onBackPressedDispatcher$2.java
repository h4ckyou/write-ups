...
final class ComponentActivity$onBackPressedDispatcher$2 extends Lambda implements Function0<OnBackPressedDispatcher> {
    ...
    public final OnBackPressedDispatcher invoke() {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            if (!Intrinsics.areEqual((Object) Looper.myLooper(), (Object) Looper.getMainLooper())) {
                new Handler(Looper.getMainLooper()).post(new ComponentActivity$onBackPressedDispatcher$2$$ExternalSyntheticLambda1(componentActivity, dispatcher));
            } else {
    ...
    public static final void invoke$lambda$0(ComponentActivity this$02) {
    ...
    /* access modifiers changed from: private */
    public static final void invoke$lambda$2$lambda$1(ComponentActivity this$02, OnBackPressedDispatcher $dispatcher) {
        Intrinsics.checkNotNullParameter(this$02, "this$0");
