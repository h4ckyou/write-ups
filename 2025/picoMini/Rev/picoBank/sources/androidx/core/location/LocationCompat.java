    ...
    private static class Api28Impl {
        ...
        static void removeSpeedAccuracy(Location location) {
            ...
            if (location.hasSpeedAccuracy()) {
                ...
                float accuracy2 = bearing5;
                float accuracy3 = location.getVerticalAccuracyMeters();
                boolean hasBearingAccuracy = location.hasBearingAccuracy();
                float verticalAccuracy = accuracy3;
                float bearingAccuracy = location.getBearingAccuracyDegrees();
                Bundle extras = location.getExtras();
                location.reset();
                location2.setProvider(provider);
                ...
                if (hasVerticalAccuracy) {
                    ...
                    location2.setVerticalAccuracyMeters(accuracy);
                } else {
                    float accuracy4 = bearing2;
                    accuracy = verticalAccuracy;
                }
                if (hasBearingAccuracy) {
                    float f3 = accuracy;
                    ...
                    float verticalAccuracy2 = accuracy;
