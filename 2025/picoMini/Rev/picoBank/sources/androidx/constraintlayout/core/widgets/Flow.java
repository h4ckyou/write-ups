        ...
        if (i != 0) {
            ...
            if (orientation == 0) {
                ...
                while (i3 < i) {
                    ...
                    boolean doWrap3 = (width == i2 || (this.mHorizontalGap + width) + w > i2) && list3.biggest != null;
                ...
                while (i4 < i) {
                    ...
                    boolean doWrap4 = (height == i2 || (this.mVerticalGap + height) + h > i2) && list5.biggest != null;
            ...
            while (i8 < listCount) {
                ...
                if (orientation == 0) {
                    if (i8 < listCount - 1) {
                        bottom = this.mChainList.get(i8 + 1).biggest.mTop;
                        paddingBottom2 = 0;
                    } else {
                        bottom = this.mBottom;
                    ...
                    if (i8 < listCount - 1) {
                        right = this.mChainList.get(i8 + 1).biggest.mLeft;
                        paddingRight2 = 0;
                    } else {
                        right = this.mRight;
        ...
        if (i != 0) {
            ...
            if (orientation == 0) {
                ...
                while (i3 < i) {
                    ...
                    boolean doWrap3 = (width == i2 || (this.mHorizontalGap + width) + w > i2) && list3.biggest != null;
                    if (doWrap3 || i3 <= 0 || this.mMaxElementsWrap <= 0 || col2 <= this.mMaxElementsWrap) {
                        doWrap2 = doWrap3;
                    } else {
                        doWrap2 = true;
                    }
