...
public class Oscillator {
    ...
    public void normalize() {
        ...
        for (int i2 = 0; i2 < this.mPeriod.length; i2++) {
            ...
            fArr[i2] = (float) (((double) fArr[i2]) * (totalCount / totalArea));
        }
        this.mArea[0] = 0.0d;
    ...
    public double getP(double time) {
        ...
        return this.mArea[index2 - 1] + ((((double) this.mPeriod[index2 - 1]) - (this.mPosition[index2 - 1] * m)) * (t - this.mPosition[index2 - 1])) + ((((t * t) - (this.mPosition[index2 - 1] * this.mPosition[index2 - 1])) * m) / 2.0d);
    }
    ...
    public double getDP(double time) {
        ...
        int index2 = (-index) - 1;
        double m = ((double) (this.mPeriod[index2] - this.mPeriod[index2 - 1])) / (this.mPosition[index2] - this.mPosition[index2 - 1]);
        return (m * time2) + (((double) this.mPeriod[index2 - 1]) - (this.mPosition[index2 - 1] * m));
    }
