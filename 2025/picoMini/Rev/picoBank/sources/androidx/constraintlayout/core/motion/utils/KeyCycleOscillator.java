...
public abstract class KeyCycleOscillator {
    ...
    private static class CoreSpline extends KeyCycleOscillator {
        String type;
        int typeId = TypedValues.CycleType.getId(this.type);
    ...
    static class CycleOscillator {
        ...
        public double getValues(float time) {
            if (this.mCurveFit != null) {
                ...
                this.mSplineValueCache[1] = (double) this.mPhase[0];
                this.mSplineValueCache[2] = (double) this.mValues[0];
            }
            return (this.mSplineValueCache[2] * this.mOscillator.getValue((double) time, this.mSplineValueCache[1])) + this.mSplineValueCache[0];
        }
