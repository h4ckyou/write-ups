...
public final class Headers implements Iterable<Pair<? extends String, ? extends String>>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final Headers of(String... namesAndValues) {
            ...
            if (namesAndValues.length % 2 == 0) {
                ...
                if (clone != null) {
                    ...
                    IntProgression step = RangesKt.step((IntProgression) ArraysKt.getIndices((T[]) namesAndValues2), 2);
        ...
        public final Headers m1785deprecated_of(String... namesAndValues) {
            Intrinsics.checkNotNullParameter(namesAndValues, "namesAndValues");
        ...
        /* renamed from: -deprecated_of  reason: not valid java name */
        public final Headers m1784deprecated_of(Map<String, String> headers) {
            Intrinsics.checkNotNullParameter(headers, "headers");
            return of(headers);
        }
