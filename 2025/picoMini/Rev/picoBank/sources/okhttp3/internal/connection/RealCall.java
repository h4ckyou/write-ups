...
public final class RealCall implements Call {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0021, code lost:
        if (r6.responseBodyOpen != false) goto L_0x0023;
     */
    ...
    public final <E extends java.io.IOException> E messageDone$okhttp(okhttp3.internal.connection.Exchange r7, boolean r8, boolean r9, E r10) {
        ...
        L_0x0010:
            ...
            boolean r4 = r6.requestBodyOpen     // Catch:{ all -> 0x001b }
        ...
        L_0x001d:
            ...
            boolean r4 = r6.responseBodyOpen     // Catch:{ all -> 0x001b }
            if (r4 == 0) goto L_0x0047
        L_0x0023:
            r4 = 0
            if (r8 == 0) goto L_0x0028
            r6.requestBodyOpen = r4     // Catch:{ all -> 0x001b }
        L_0x0028:
            if (r9 == 0) goto L_0x002c
            r6.responseBodyOpen = r4     // Catch:{ all -> 0x001b }
        L_0x002c:
            boolean r5 = r6.requestBodyOpen     // Catch:{ all -> 0x001b }
            if (r5 != 0) goto L_0x0036
            boolean r5 = r6.responseBodyOpen     // Catch:{ all -> 0x001b }
            if (r5 != 0) goto L_0x0036
            r5 = r1
            goto L_0x0037
        L_0x0036:
        ...
        L_0x0037:
            ...
            boolean r5 = r6.responseBodyOpen     // Catch:{ all -> 0x001b }
            if (r5 != 0) goto L_0x0045
            boolean r5 = r6.expectMoreExchanges     // Catch:{ all -> 0x001b }
            if (r5 != 0) goto L_0x0045
            goto L_0x0046
        L_0x0045:
            r1 = r4
        ...
        if (!Util.assertionsEnabled || !Thread.holdsLock(this)) {
            ...
            if ($this$assertThreadDoesntHoldLock$iv != null) {
                ...
                if (!Util.assertionsEnabled || !Thread.holdsLock($this$assertThreadDoesntHoldLock$iv2)) {
                    ...
                    Thread currentThread = Thread.currentThread();
                    Intrinsics.checkNotNullExpressionValue(currentThread, "Thread.currentThread()");
                    throw new AssertionError(append.append(currentThread.getName()).append(" MUST NOT hold lock on ").append($this$assertThreadDoesntHoldLock$iv2).toString());
                }
            }
    ...
    public final class AsyncCall implements Runnable {
        ...
        public void run() {
            ...
            Intrinsics.checkNotNullExpressionValue(currentThread$iv, "currentThread");
