...
public final class Exchange {
    ...
    private final RealConnection connection = this.codec.getConnection();
    ...
    public final ResponseBody openResponseBody(Response response) throws IOException {
        Intrinsics.checkNotNullParameter(response, "response");
        try {
            String contentType = Response.header$default(response, HttpHeaderParser.HEADER_CONTENT_TYPE, (String) null, 2, (Object) null);
    ...
    private final class RequestBodySink extends ForwardingSink {
        ...
        public void write(Buffer source, long byteCount) throws IOException {
            ...
            } else if (this.contentLength == -1 || this.bytesReceived + byteCount <= this.contentLength) {
                try {
