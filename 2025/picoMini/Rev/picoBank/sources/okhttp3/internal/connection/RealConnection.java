...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private final void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r17) throws java.io.IOException {
        /*
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNull(r3)     // Catch:{ all -> 0x01ba }
            java.net.Socket r6 = r1.rawSocket     // Catch:{ all -> 0x01ba }
            okhttp3.HttpUrl r7 = r2.url()     // Catch:{ all -> 0x01ba }
            java.lang.String r7 = r7.host()     // Catch:{ all -> 0x01ba }
            okhttp3.HttpUrl r8 = r2.url()     // Catch:{ all -> 0x01ba }
            int r8 = r8.port()     // Catch:{ all -> 0x01ba }
            r9 = 1
            java.net.Socket r6 = r3.createSocket(r6, r7, r8, r9)     // Catch:{ all -> 0x01ba }
            if (r6 == 0) goto L_0x01ae
            javax.net.ssl.SSLSocket r6 = (javax.net.ssl.SSLSocket) r6     // Catch:{ all -> 0x01ba }
            r5 = r6
            r6 = r17
            okhttp3.ConnectionSpec r7 = r6.configureSecureSocket(r5)     // Catch:{ all -> 0x01b8 }
            boolean r8 = r7.supportsTlsExtensions()     // Catch:{ all -> 0x01b8 }
            if (r8 == 0) goto L_0x0052
            okhttp3.internal.platform.Platform$Companion r8 = okhttp3.internal.platform.Platform.Companion     // Catch:{ all -> 0x01b8 }
            okhttp3.internal.platform.Platform r8 = r8.get()     // Catch:{ all -> 0x01b8 }
            okhttp3.HttpUrl r10 = r2.url()     // Catch:{ all -> 0x01b8 }
            java.lang.String r10 = r10.host()     // Catch:{ all -> 0x01b8 }
            java.util.List r11 = r2.protocols()     // Catch:{ all -> 0x01b8 }
            r8.configureTlsExtensions(r5, r10, r11)     // Catch:{ all -> 0x01b8 }
        L_0x0052:
            r5.startHandshake()     // Catch:{ all -> 0x01b8 }
            javax.net.ssl.SSLSession r8 = r5.getSession()     // Catch:{ all -> 0x01b8 }
            okhttp3.Handshake$Companion r10 = okhttp3.Handshake.Companion     // Catch:{ all -> 0x01b8 }
            java.lang.String r11 = "sslSocketSession"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r8, r11)     // Catch:{ all -> 0x01b8 }
            okhttp3.Handshake r10 = r10.get(r8)     // Catch:{ all -> 0x01b8 }
            javax.net.ssl.HostnameVerifier r11 = r2.hostnameVerifier()     // Catch:{ all -> 0x01b8 }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r11)     // Catch:{ all -> 0x01b8 }
            okhttp3.HttpUrl r12 = r2.url()     // Catch:{ all -> 0x01b8 }
            java.lang.String r12 = r12.host()     // Catch:{ all -> 0x01b8 }
            boolean r11 = r11.verify(r12, r8)     // Catch:{ all -> 0x01b8 }
            if (r11 != 0) goto L_0x012b
            java.util.List r11 = r10.peerCertificates()     // Catch:{ all -> 0x01b8 }
            r12 = r11
            java.util.Collection r12 = (java.util.Collection) r12     // Catch:{ all -> 0x01b8 }
            boolean r12 = r12.isEmpty()     // Catch:{ all -> 0x01b8 }
            r12 = r12 ^ r9
            if (r12 == 0) goto L_0x0102
            r12 = 0
            java.lang.Object r12 = r11.get(r12)     // Catch:{ all -> 0x01b8 }
            if (r12 != 0) goto L_0x0097
            java.lang.NullPointerException r0 = new java.lang.NullPointerException     // Catch:{ all -> 0x01b8 }
            java.lang.String r9 = "null cannot be cast to non-null type java.security.cert.X509Certificate"
            r0.<init>(r9)     // Catch:{ all -> 0x01b8 }
            throw r0     // Catch:{ all -> 0x01b8 }
        L_0x0097:
            java.security.cert.X509Certificate r12 = (java.security.cert.X509Certificate) r12     // Catch:{ all -> 0x01b8 }
            javax.net.ssl.SSLPeerUnverifiedException r13 = new javax.net.ssl.SSLPeerUnverifiedException     // Catch:{ all -> 0x01b8 }
            java.lang.StringBuilder r14 = new java.lang.StringBuilder     // Catch:{ all -> 0x01b8 }
            r14.<init>()     // Catch:{ all -> 0x01b8 }
            java.lang.String r15 = "\n              |Hostname "
            java.lang.StringBuilder r14 = r14.append(r15)     // Catch:{ all -> 0x01b8 }
            okhttp3.HttpUrl r15 = r2.url()     // Catch:{ all -> 0x01b8 }
            java.lang.String r15 = r15.host()     // Catch:{ all -> 0x01b8 }
            java.lang.StringBuilder r14 = r14.append(r15)     // Catch:{ all -> 0x01b8 }
            java.lang.String r15 = " not verified:\n              |    certificate: "
            java.lang.StringBuilder r14 = r14.append(r15)     // Catch:{ all -> 0x01b8 }
            okhttp3.CertificatePinner$Companion r15 = okhttp3.CertificatePinner.Companion     // Catch:{ all -> 0x01b8 }
            r0 = r12
            java.security.cert.Certificate r0 = (java.security.cert.Certificate) r0     // Catch:{ all -> 0x01b8 }
            java.lang.String r0 = r15.pin(r0)     // Catch:{ all -> 0x01b8 }
            java.lang.StringBuilder r0 = r14.append(r0)     // Catch:{ all -> 0x01b8 }
            java.lang.String r14 = "\n              |    DN: "
            java.lang.StringBuilder r0 = r0.append(r14)     // Catch:{ all -> 0x01b8 }
            java.security.Principal r14 = r12.getSubjectDN()     // Catch:{ all -> 0x01b8 }
            java.lang.String r15 = "cert.subjectDN"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r14, r15)     // Catch:{ all -> 0x01b8 }
            java.lang.String r14 = r14.getName()     // Catch:{ all -> 0x01b8 }
            java.lang.StringBuilder r0 = r0.append(r14)     // Catch:{ all -> 0x01b8 }
            java.lang.String r14 = "\n              |    subjectAltNames: "
            java.lang.StringBuilder r0 = r0.append(r14)     // Catch:{ all -> 0x01b8 }
            okhttp3.internal.tls.OkHostnameVerifier r14 = okhttp3.internal.tls.OkHostnameVerifier.INSTANCE     // Catch:{ all -> 0x01b8 }
            java.util.List r14 = r14.allSubjectAltNames(r12)     // Catch:{ all -> 0x01b8 }
            java.lang.StringBuilder r0 = r0.append(r14)     // Catch:{ all -> 0x01b8 }
            java.lang.String r14 = "\n              "
            java.lang.StringBuilder r0 = r0.append(r14)     // Catch:{ all -> 0x01b8 }
            java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x01b8 }
            r14 = 0
            java.lang.String r0 = kotlin.text.StringsKt.trimMargin$default(r0, r14, r9, r14)     // Catch:{ all -> 0x01b8 }
            r13.<init>(r0)     // Catch:{ all -> 0x01b8 }
            java.lang.Throwable r13 = (java.lang.Throwable) r13     // Catch:{ all -> 0x01b8 }
            throw r13     // Catch:{ all -> 0x01b8 }
        L_0x0102:
            javax.net.ssl.SSLPeerUnverifiedException r0 = new javax.net.ssl.SSLPeerUnverifiedException     // Catch:{ all -> 0x01b8 }
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ all -> 0x01b8 }
            r9.<init>()     // Catch:{ all -> 0x01b8 }
            java.lang.String r12 = "Hostname "
            java.lang.StringBuilder r9 = r9.append(r12)     // Catch:{ all -> 0x01b8 }
            okhttp3.HttpUrl r12 = r2.url()     // Catch:{ all -> 0x01b8 }
            java.lang.String r12 = r12.host()     // Catch:{ all -> 0x01b8 }
            java.lang.StringBuilder r9 = r9.append(r12)     // Catch:{ all -> 0x01b8 }
            java.lang.String r12 = " not verified (no certificates)"
            java.lang.StringBuilder r9 = r9.append(r12)     // Catch:{ all -> 0x01b8 }
            java.lang.String r9 = r9.toString()     // Catch:{ all -> 0x01b8 }
            r0.<init>(r9)     // Catch:{ all -> 0x01b8 }
            java.lang.Throwable r0 = (java.lang.Throwable) r0     // Catch:{ all -> 0x01b8 }
            throw r0     // Catch:{ all -> 0x01b8 }
        L_0x012b:
            r14 = r0
            okhttp3.CertificatePinner r0 = r2.certificatePinner()     // Catch:{ all -> 0x01b8 }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)     // Catch:{ all -> 0x01b8 }
            okhttp3.Handshake r9 = new okhttp3.Handshake     // Catch:{ all -> 0x01b8 }
            okhttp3.TlsVersion r11 = r10.tlsVersion()     // Catch:{ all -> 0x01b8 }
            okhttp3.CipherSuite r12 = r10.cipherSuite()     // Catch:{ all -> 0x01b8 }
            java.util.List r13 = r10.localCertificates()     // Catch:{ all -> 0x01b8 }
            okhttp3.internal.connection.RealConnection$connectTls$1 r15 = new okhttp3.internal.connection.RealConnection$connectTls$1     // Catch:{ all -> 0x01b8 }
            r15.<init>(r0, r10, r2)     // Catch:{ all -> 0x01b8 }
            kotlin.jvm.functions.Function0 r15 = (kotlin.jvm.functions.Function0) r15     // Catch:{ all -> 0x01b8 }
            r9.<init>(r11, r12, r13, r15)     // Catch:{ all -> 0x01b8 }
            r1.handshake = r9     // Catch:{ all -> 0x01b8 }
            okhttp3.HttpUrl r9 = r2.url()     // Catch:{ all -> 0x01b8 }
            java.lang.String r9 = r9.host()     // Catch:{ all -> 0x01b8 }
            okhttp3.internal.connection.RealConnection$connectTls$2 r11 = new okhttp3.internal.connection.RealConnection$connectTls$2     // Catch:{ all -> 0x01b8 }
            r11.<init>(r1)     // Catch:{ all -> 0x01b8 }
            kotlin.jvm.functions.Function0 r11 = (kotlin.jvm.functions.Function0) r11     // Catch:{ all -> 0x01b8 }
            r0.check$okhttp(r9, r11)     // Catch:{ all -> 0x01b8 }
            boolean r9 = r7.supportsTlsExtensions()     // Catch:{ all -> 0x01b8 }
            if (r9 == 0) goto L_0x0171
            okhttp3.internal.platform.Platform$Companion r9 = okhttp3.internal.platform.Platform.Companion     // Catch:{ all -> 0x01b8 }
            okhttp3.internal.platform.Platform r9 = r9.get()     // Catch:{ all -> 0x01b8 }
            java.lang.String r9 = r9.getSelectedProtocol(r5)     // Catch:{ all -> 0x01b8 }
            r14 = r9
            goto L_0x0172
        L_0x0171:
        L_0x0172:
            r9 = r14
            r11 = r5
            java.net.Socket r11 = (java.net.Socket) r11     // Catch:{ all -> 0x01b8 }
            r1.socket = r11     // Catch:{ all -> 0x01b8 }
            r11 = r5
            java.net.Socket r11 = (java.net.Socket) r11     // Catch:{ all -> 0x01b8 }
            okio.Source r11 = okio.Okio.source((java.net.Socket) r11)     // Catch:{ all -> 0x01b8 }
            okio.BufferedSource r11 = okio.Okio.buffer((okio.Source) r11)     // Catch:{ all -> 0x01b8 }
            r1.source = r11     // Catch:{ all -> 0x01b8 }
            r11 = r5
            java.net.Socket r11 = (java.net.Socket) r11     // Catch:{ all -> 0x01b8 }
            okio.Sink r11 = okio.Okio.sink((java.net.Socket) r11)     // Catch:{ all -> 0x01b8 }
            okio.BufferedSink r11 = okio.Okio.buffer((okio.Sink) r11)     // Catch:{ all -> 0x01b8 }
            r1.sink = r11     // Catch:{ all -> 0x01b8 }
            if (r9 == 0) goto L_0x019b
            okhttp3.Protocol$Companion r11 = okhttp3.Protocol.Companion     // Catch:{ all -> 0x01b8 }
            okhttp3.Protocol r11 = r11.get(r9)     // Catch:{ all -> 0x01b8 }
            goto L_0x019d
        L_0x019b:
            okhttp3.Protocol r11 = okhttp3.Protocol.HTTP_1_1     // Catch:{ all -> 0x01b8 }
        L_0x019d:
            r1.protocol = r11     // Catch:{ all -> 0x01b8 }
            r0 = 1
