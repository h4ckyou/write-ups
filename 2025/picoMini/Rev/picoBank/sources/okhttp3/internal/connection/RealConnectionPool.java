...
public final class RealConnectionPool {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x009f, code lost:
        if (r13.connections.isEmpty() == false) goto L_0x00a6;
     */
    ...
    public final long cleanup(long r14) {
        ...
        L_0x0066:
            ...
            monitor-enter(r5)
            r6 = 0
            java.util.List r7 = r5.getCalls()     // Catch:{ all -> 0x00a7 }
            java.util.Collection r7 = (java.util.Collection) r7     // Catch:{ all -> 0x00a7 }
            boolean r7 = r7.isEmpty()     // Catch:{ all -> 0x00a7 }
            r8 = 1
            r7 = r7 ^ r8
            r9 = 0
            ...
            return r9
        L_0x007e:
            long r11 = r5.getIdleAtNs$okhttp()     // Catch:{ all -> 0x00a7 }
            long r11 = r11 + r3
            ...
            return r9
        L_0x0089:
            r5.setNoNewExchanges(r8)     // Catch:{ all -> 0x00a7 }
            java.util.concurrent.ConcurrentLinkedQueue<okhttp3.internal.connection.RealConnection> r7 = r13.connections     // Catch:{ all -> 0x00a7 }
            r7.remove(r2)     // Catch:{ all -> 0x00a7 }
            monitor-exit(r5)
