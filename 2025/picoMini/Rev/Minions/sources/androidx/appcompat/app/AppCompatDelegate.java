...
public abstract class AppCompatDelegate {
    ...
    public static void syncRequestedAndStoredLocales(android.content.Context r3) {
        ...
        L_0x001c:
            ...
            java.lang.String r1 = androidx.appcompat.app.AppLocalesStorageHelper.readLocales(r3)     // Catch:{ all -> 0x005a }
        ...
        L_0x0041:
            ...
            androidx.appcompat.app.AppLocalesStorageHelper.persistLocales(r3, r1)     // Catch:{ all -> 0x005a }
        L_0x0058:
            monitor-exit(r0)     // Catch:{ all -> 0x005a }
        L_0x0059:
            return
