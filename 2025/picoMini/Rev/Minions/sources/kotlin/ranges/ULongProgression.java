...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step2) {
        if (step2 == 0) {
            ...
            this.first = start;
            this.last = UProgressionUtilKt.m1336getProgressionLastElement7ftBX0g(start, endInclusive, step2);
            this.step = step2;
        } else {
    ...
    public final long m1360getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU  reason: not valid java name */
    public final long m1361getLastsVKNKU() {
        return this.last;
    }
    ...
    public int hashCode() {
        ...
        return (((((int) ULong.m295constructorimpl(this.first ^ ULong.m295constructorimpl(this.first >>> 32))) * 31) + ((int) ULong.m295constructorimpl(this.last ^ ULong.m295constructorimpl(this.last >>> 32)))) * 31) + ((int) (this.step ^ (this.step >>> 32)));
    }
    ...
    public String toString() {
        ...
        StringBuilder sb;
        if (this.step > 0) {
            sb = new StringBuilder().append(ULong.m341toStringimpl(this.first)).append("..").append(ULong.m341toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder().append(ULong.m341toStringimpl(this.first)).append(" downTo ").append(ULong.m341toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1362fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
