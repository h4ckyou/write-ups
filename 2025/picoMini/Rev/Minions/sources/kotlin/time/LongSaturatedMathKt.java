...
public final class LongSaturatedMathKt {
    ...
    public static final long m1581saturatingAddpTJri5U(long longNs, long duration) {
        long durationNs = Duration.m1473getInWholeNanosecondsimpl(duration);
        boolean z = true;
        if (((longNs - 1) | 1) == Long.MAX_VALUE) {
            return m1580checkInfiniteSumDefinedPjuGub4(longNs, duration, durationNs);
        }
        if ((1 | (durationNs - 1)) != Long.MAX_VALUE) {
            z = false;
        }
        if (z) {
            return m1582saturatingAddInHalvespTJri5U(longNs, duration);
        }
    ...
    private static final long m1580checkInfiniteSumDefinedPjuGub4(long longNs, long duration, long durationNs) {
        if (!Duration.m1485isInfiniteimpl(duration) || (longNs ^ durationNs) >= 0) {
            return longNs;
        }
    ...
    private static final long m1582saturatingAddInHalvespTJri5U(long longNs, long duration) {
        long half = Duration.m1456divUwyO8pc(duration, 2);
        if ((1 | (Duration.m1473getInWholeNanosecondsimpl(half) - 1)) == Long.MAX_VALUE) {
            return (long) (((double) longNs) + Duration.m1496toDoubleimpl(duration, DurationUnit.NANOSECONDS));
        }
        return m1581saturatingAddpTJri5U(m1581saturatingAddpTJri5U(longNs, half), Duration.m1488minusLRDsOJo(duration, half));
    }

    public static final long saturatingDiff(long valueNs, long originNs) {
        if ((1 | (originNs - 1)) == Long.MAX_VALUE) {
            return Duration.m1505unaryMinusUwyO8pc(DurationKt.toDuration(originNs, DurationUnit.DAYS));
        }
    ...
    public static final long saturatingOriginsDiff(long origin1Ns, long origin2Ns) {
        ...
        if (!(((origin2Ns - 1) | 1) == Long.MAX_VALUE)) {
            ...
            return Duration.m1505unaryMinusUwyO8pc(DurationKt.toDuration(origin2Ns, DurationUnit.DAYS));
        }
    }
    ...
    private static final long saturatingFiniteDiff(long value1Ns, long value2Ns) {
        ...
        if (((result ^ value1Ns) & (~(result ^ value2Ns))) < 0) {
            ...
            return Duration.m1489plusLRDsOJo(duration, DurationKt.toDuration(resultNs, DurationUnit.NANOSECONDS));
        }
