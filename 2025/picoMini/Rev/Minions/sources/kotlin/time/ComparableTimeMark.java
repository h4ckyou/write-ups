...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark m1445minusLRDsOJo(long j);

    /* renamed from: minus-UwyO8pc  reason: not valid java name */
    long m1446minusUwyO8pc(ComparableTimeMark comparableTimeMark);

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    ComparableTimeMark m1447plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static ComparableTimeMark m1448minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.m1447plusLRDsOJo(Duration.m1505unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m1452compareToLRDsOJo($this.m1446minusUwyO8pc(other), Duration.Companion.m1555getZEROUwyO8pc());
        }
    }
}
