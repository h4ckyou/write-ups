...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark m1430minusLRDsOJo(long duration) {
            return ComparableTimeMark.DefaultImpls.m1448minusLRDsOJo(this, duration);
        }

        /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
        public long m1428elapsedNowUwyO8pc() {
            return Duration.m1488minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public ComparableTimeMark m1433plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1489plusLRDsOJo(this.offset, duration), (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-UwyO8pc  reason: not valid java name */
        public long m1431minusUwyO8pc(ComparableTimeMark other) {
            ...
            } else if (Duration.m1458equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m1485isInfiniteimpl(this.offset)) {
                return Duration.Companion.m1555getZEROUwyO8pc();
            } else {
                long offsetDiff = Duration.m1488minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
        ...
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual((Object) this.timeSource, (Object) ((DoubleTimeMark) other).timeSource) && Duration.m1458equalsimpl0(m1431minusUwyO8pc((ComparableTimeMark) other), Duration.Companion.m1555getZEROUwyO8pc());
        }

        public int hashCode() {
            return Duration.m1481hashCodeimpl(Duration.m1489plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + Duration.m1502toStringimpl(this.offset) + ", " + this.timeSource + ')';
        }
    }

    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m1555getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
