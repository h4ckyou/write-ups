...
public final class ULongArrayKt {
    private static final long[] ULongArray(int size, Function1<? super Integer, ULong> init) {
        ...
        for (int i = 0; i < size; i++) {
            jArr[i] = init.invoke(Integer.valueOf(i)).m347unboximpl();
        }
        return ULongArray.m350constructorimpl(jArr);
    }

    /* renamed from: ulongArrayOf-QwZRm1k  reason: not valid java name */
    private static final long[] m366ulongArrayOfQwZRm1k(long... elements) {
