...
public final class UStringsKt {
    ...
    public static final String m1425toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1427toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1426toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1424toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final byte toUByte(String $this$toUByte) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m189unboximpl();
        }
    ...
    public static final short toUShort(String $this$toUShort) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m452unboximpl();
        }
    ...
    public static final int toUInt(String $this$toUInt) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m268unboximpl();
        }
    ...
    public static final long toULong(String $this$toULong) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m347unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m268unboximpl();
        if (Integer.compare(r0 ^ Integer.MIN_VALUE, UInt.m216constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m133boximpl(UByte.m139constructorimpl((byte) r0));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m268unboximpl();
        if (Integer.compare(r0 ^ Integer.MIN_VALUE, UInt.m216constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m396boximpl(UShort.m402constructorimpl((short) r0));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m216constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m216constructorimpl(result * uradix);
            int beforeAdding = result2;
            result = UInt.m216constructorimpl(UInt.m216constructorimpl(digit) + result2);
            if (Integer.compare(result ^ Integer.MIN_VALUE, beforeAdding ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
        }
        return UInt.m210boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m295constructorimpl((long) i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m295constructorimpl(result * uradix);
            long beforeAdding = result2;
            result = ULong.m295constructorimpl(ULong.m295constructorimpl(((long) UInt.m216constructorimpl(digit)) & 4294967295L) + result2);
        ...
        return ULong.m289boximpl(result);
    }
}
