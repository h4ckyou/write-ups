...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m1669catch(Flow<? extends T> $this$catch, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> action) {
        return FlowKt__ErrorsKt.m1676catch($this$catch, action);
    }
    ...
    public static final <T> Flow<T> m1670debounceHG0u8IE(Flow<? extends T> $this$debounce_u2dHG0u8IE, long timeout) {
        return FlowKt__DelayKt.m1672debounceHG0u8IE($this$debounce_u2dHG0u8IE, timeout);
    }
    ...
    public static final <T> Flow<T> m1671sampleHG0u8IE(Flow<? extends T> $this$sample_u2dHG0u8IE, long period) {
        return FlowKt__DelayKt.m1673sampleHG0u8IE($this$sample_u2dHG0u8IE, period);
    }
