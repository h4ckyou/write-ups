...
public final class DelayKt {
    ...
    public static final Object m1625delayVtjQ1oo(long duration, Continuation<? super Unit> $completion) {
        Object delay = delay(m1626toDelayMillisLRDsOJo(duration), $completion);
    ...
    public static final long m1626toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        if (Duration.m1452compareToLRDsOJo($this$toDelayMillis_u2dLRDsOJo, Duration.Companion.m1555getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1471getInWholeMillisecondsimpl($this$toDelayMillis_u2dLRDsOJo), 1);
        }
        return 0;
    }
}
