...
public final class TimeoutKt {
    ...
    public static final <T> Object m1628withTimeoutKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> block, Continuation<? super T> $completion) {
        return withTimeout(DelayKt.m1626toDelayMillisLRDsOJo(timeout), block, $completion);
    }
    ...
    public static final <T> Object m1629withTimeoutOrNullKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> block, Continuation<? super T> $completion) {
        return withTimeoutOrNull(DelayKt.m1626toDelayMillisLRDsOJo(timeout), block, $completion);
    }
